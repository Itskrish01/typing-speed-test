...
export const ProfileBanner = ({ displayName, joinedDate, testsCount, onEdit }: ProfileBannerProps) => {
    return (
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {onEdit && (
                            <Button
                                variant="ghost"
                                size="icon"
                                className="h-6 w-6 opacity-30 hover:opacity-100 hover:bg-transparent transition-opacity"
                                onClick={onEdit}
                            >
