...
export const Leaderboard = () => {
    ...
    return (
        <PageLayout>
            <main className="flex-1 flex flex-col items-center py-8 sm:py-12 w-full">
                {/* Header */}
                <header className="text-center mb-10 sm:mb-12">
                    ...
                    <p className="text-muted-foreground">Top 50 typists in Ranked Mode</p>
                </header>
                ...
                <div className="w-full max-w-2xl px-4">
                    {loading ? (
                        ...
                        <div className="text-center py-16 bg-card/50 border border-border/50 rounded-2xl">
                        ...
                        <div className="bg-card/50 border border-border/50 rounded-2xl overflow-hidden">
                            {/* Table Header */}
                            <div
                                className="grid grid-cols-[56px_1fr_100px] sm:grid-cols-[72px_1fr_120px] gap-4 px-4 sm:px-6 py-4 bg-muted/20 border-b border-border/50"
                                role="row"
                            >
                                <div className="text-xs uppercase tracking-wider font-semibold text-muted-foreground" role="columnheader">
                                    Rank
                                </div>
                                <div className="text-xs uppercase tracking-wider font-semibold text-muted-foreground" role="columnheader">
                                    Player
                                </div>
                                <div className="text-xs uppercase tracking-wider font-semibold text-muted-foreground text-right" role="columnheader">
                                    Best WPM
                                </div>
                            </div>
                                ...
                                <div className="border-b border-border/30">
                                    {entries.slice(0, 3).map((entry) => (
                                        <div
                                            key={entry.uid}
                                            className={cn(
                                                "grid grid-cols-[56px_1fr_100px] sm:grid-cols-[72px_1fr_120px] gap-4 px-4 sm:px-6 py-5 items-center",
                                        ...
                                        >
                                            ...
                                            <div className="text-right" role="cell">
                                                ...
                                                <span className="text-muted-foreground text-xs ml-1">wpm</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            {entries.slice(3).length > 0 && (
                                <div className="divide-y divide-border/30" role="rowgroup">
                                    {entries.slice(3).map((entry) => (
                                        <div
                                            key={entry.uid}
                                            className="grid grid-cols-[56px_1fr_100px] sm:grid-cols-[72px_1fr_120px] gap-4 px-4 sm:px-6 py-4 items-center hover:bg-muted/10 transition-colors"
                                            role="row"
                                        >
                                            <div className="flex items-center" role="cell">
                                                {getRankDisplay(entry.rank)}
